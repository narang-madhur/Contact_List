	...
	public:
	    	...
	    	if(Ecommand==1)
	    	{
	        	...
	        	if(Echeck==true)
	        	{
	        	    ...
	        	    if(command==1)
	        	    {
	        		    ...
	        		    cout<<"  Contact Edited Succesfully"<<endl;
			    	}
			    	else
			    	{
		...
		void reopenCB()
		{
            ...
            else
            {
            	cout<<endl;
    			cout<<"*********************************"<<endl;
            	cout<<"  New Contact book is opened."<<endl;
            	cout<<"*********************************"<<endl<<endl;
			}
		}
		...
		void Structure()
    	{
	    	...
	    	cout<<"  7. Exit the Contact_List"<<endl;
	    	cout<<"*********************************"<<endl;
	    	...
	    	try
	    	{
	    		if(Scommand>=1&&Scommand<=7)
	    		{
	            	...
	            	{
	            		cout<<"  Contact list has been exited."<<endl;	
		        	}
				}
				else
				{
...
{   
	...
	cout<<endl;
    cout<<"********************************************"<<endl;
	cout<<"  WELCOME TO MADHUR NARANG'S CONTACT_BOOK      "<<endl;
	cout<<"********************************************"<<endl<<endl;
	cb.Structure();
	return 0;
}
